...
완속 충전기의 80% 충전시까지 걸리는 시간은 평균적으로 5시간 가량이다.
따라서 퇴근 시간 이후 충전이 활발한 시간대인 17시 ~ 02시 (9시간)동안, 충전기 한대당 채 두대가 충전하지 못한다.  

따라서 차량이 3일에 한번씩만 충전한다고 하더라도, 충전기 한개 당 담당하는 전기차 수가 6이 넘지 않아야 충전기가 부족하지 않다고 볼 수 있다.

그러나, 모든 자치구가 6이 넘는 수치를 지녔다. 최소 수치인 도봉구조차 충전기 한 개당 9대의 전기차를 담당해야한다. 해당 수치를 보아, 다음을 확정지을 수 있다.

## 전기차 충전소는 모든 차량을 담당하기에 부족하다.

이는 절대적인 개수의 문제이기도 하지만, 충전의 수요가 밤 시간대로 몰리는 것이 부족의 더 큰 원인이 된다고 분석할 수 있었다.  
또한, 급속충전기에 비해 완속충전기의 사용빈도가 훨씬 높기에, 충전기가 더 부족하게 느껴진다고 해석할 수 있다.
